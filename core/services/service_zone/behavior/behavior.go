...
func (ab *ZoneActorBehavior) Persist(entities []mme_agent.IEntity) {
	ab.ctx.Persist(entities...)
}

func (ab *ZoneActorBehavior) PackEntityChangeNotify(entities []mme_agent.IEntity, messages []network.Message) []network.Message {
...
func (ab *ZoneActorBehavior) SendMessage(request network.IClientRequest, entities []mme_agent.IEntity, resp proto.Message, respName string) {
...
func packEntityChange(entity mme_agent.IEntity) (*core.EntityChange, error) {
